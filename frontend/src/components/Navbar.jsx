...
function Navbar() {
  ...
  return (
    <>
    <main>
        <div className={`flex items-center justify-center bg-secondary border-b shadow-sm border-slate-300 p-2 transform transition-transform duration-300 ${isSidebarOpen?'translate-x-[450px] fixed w-[80%]':'translate-0'}`}>
            <div className='flex flex-row w-[80%] items-center justify-between'>
            <p onClick={() => setIsSidebaropen(true)} className='text-4xl cursor-pointer text-gray-600'><MdMenu /><span className='text-lg font-semibold'>Menu</span></p>
                <p onClick={() => setIscalendarOpen(!isCalendarOpen)} className='text-4xl cursor-pointer text-gray-600'><SlCalender /><span className='text-lg font-semibold'>Calendar</span></p>
                <Link to='/all'>
                    <p className='text-4xl cursor-pointer text-gray-600'><FaTasks /><span className='text-lg font-semibold '>Tasks</span></p>
                </Link>
                <Link to='/profile'>
                    <p className='text-4xl cursor-pointer text-gray-600'><CgProfile /><span className='text-lg font-semibold '>Mine</span></p>
                </Link>
            </div>
        </div>
        {/*Calender popup*/}
